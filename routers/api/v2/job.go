...
// @produce json
// @accept json
// @success 200 {object} controller.Response{Data=[]v2.Job}
...
// @success 200 {object} controller.Response{Data=v2.Job}
// @failure 500 {object} controller.Response
// @router /api/v2/jobs/{name}/log [get]
func (c *JobController) GetJobLog(ctx *gin.Context) {
	...
	if download == "true" {
		jobPath, err := helper.V2.Job.GetLogPath(jobDirs, name)
		if err != nil {
		...
		defer cancel()
		logWatcher, err := helper.V2.Job.WatchLog(watchCtx, jobDirs, name)
		if err != nil {
			log.Error(err)
			return
		}
		...
		// 非侦听模式
		result, err := helper.V2.Job.GetLog(jobDirs, name)
		if err != nil {
			c.Response(ctx, 500, e.ERROR, err.Error(), nil)
			return
		}
...
// @produce json
// @accept json
// @param body body v2.Job true "任务信息"
// @success 200 {object} controller.Response{Data=v2.Job}
// @failure 500 {object} controller.Response
...
// @success 200 {object} controller.Response{Data=v2.Job}
// @failure 500 {object} controller.Response
// @router /api/v2/jobs/{name} [delete]
...
func NewJobController() JobController {
	return JobController{
		BaseController: controller.NewController(v2.NewJobRegistry()),
	}
}
